  ...
  <div class="outer">
    <div class="slinner">
      ...
      <div class="controll">
        ...
        <div class="up controllbtn"><div></div></div>
        <?php endif; ?>
        <div class="dots" style="height: <?php echo count($tthis->slides)*19; ?>px; margin-top: -<?php echo count($tthis->slides)*19/2; ?>px;">
          <?php foreach($tthis->slides as $slide): ?>
            <div class="dot"></div>
          <?php ++$x; endforeach; ?>
        </div>
        <?php if($tthis->slider->params->get('ctrlbtn', 1)): ?>
        <div class="down controllbtn"><div></div></div>
        <?php endif; ?>
      </div>
    </div>
  </div>
...
sliderDojo.addOnLoad(sliderDojo,function(){
  var dojo = this;
  new OfflajnSliderSimpleVertical({
